...
class Lokasi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('deskripsi, encoded_polyline, last_edited', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, nama, deskripsi, encoded_polyline, last_edited', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('encoded_polyline',$this->encoded_polyline,true);
