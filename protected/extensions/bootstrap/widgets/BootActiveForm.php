...
class BootActiveForm extends CActiveForm
{
	...
	public function init()
	{
        ...
        if ($this->inlineErrors)
            $this->errorMessageCssClass =  CHtml::$errorCss;
        else
            $this->errorMessageCssClass = 'help-block '. ' <br/> '. CHtml::$errorCss;
	...
	public static function getErrorHtml($model, $attribute, $htmlOptions = array())
	{
		...
		if ($error !== null)
			return CHtml::tag('div', $htmlOptions, $error); // Bootstrap errors must be spans
		else
			return '';
	}
